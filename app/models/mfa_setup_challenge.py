...
class MFASetupChallenge(Base):
    ...
    __table_args__ = (
        Index("ix_mfa_setup_challenges_admin_id", "admin_id"),
        Index("ix_mfa_setup_challenges_app_user_id", "app_user_id"),
        Index("ix_mfa_setup_challenges_expires_at", "expires_at"),
        Index("ix_mfa_setup_challenges_revoked_at", "revoked_at"),
    )
